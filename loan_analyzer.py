...
print (f"Number of loans in the list: {loan_number: 0.0f}")

# What is the total of all loans?
# @TODO: Use the `sum` function to calculate the total of all loans in the list.
# Print the total value of the loans
loan_totals = sum (loan_costs)
print (f"Total loan value: {loan_totals: 0.0f}")

# What is the average loan amount from the list?
# @TODO: Using the sum of all loans and the total number of loans, calculate the average loan price.
# Print the average loan amount
loan_average = loan_totals / loan_number
print (f"Average loan value: {loan_average: 0.0f}")
...
print (f"Present Value: $ {present_value: 0.2f}")
...
present_value = round ((pv (new_loan ["future_value"],new_loan ["remaining_months"],annual_discount_rate)),2)
